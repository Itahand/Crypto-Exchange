  ...
  describe('Making orders', async() => {
    ...
    describe('Success', async () => {
      ...
      it('emits an Order event', async () => {
        ...
        expect(args.user).to.equal(user1.address)
        expect(args.tokenGet).to.be.equal(token2.address)
        expect(args.amountGet).to.be.equal(amountGet)
        expect(args.tokenGive).to.be.equal(token1.address)
        expect(args.amountGive).to.be.equal(amountGive)
